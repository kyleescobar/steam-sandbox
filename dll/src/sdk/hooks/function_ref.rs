    ...
    (
        ...
        $(
            ...
            $vs static mut $name: $name = $name {
                offset: std::cell::RefCell::new($crate::sdk::hooks::FunctionAddress::Offset($crate::faithe::__define_offset!($sep $var)))
            };
            ...
            impl $crate::sdk::hooks::FunctionRef for $name {
                type Target = $(extern $($cc)?)? fn($($arg_ty),*) $(-> $ret_ty)?;

                fn get_ptr(&self) -> *const () {
                    match &*self.offset.borrow() {
                        $crate::sdk::hooks::FunctionAddress::Offset(offset) => {
                        ...
                        $crate::sdk::hooks::FunctionAddress::Pointer(ptr) => *ptr
                    }
                }
                ...
                fn set_target(&self, new_fn: *const ()) {
                    ...
                    *current = $crate::sdk::hooks::FunctionAddress::Pointer(new_fn);
                }
            }
            ...
            impl $name {
                ...
                $vs fn call(&self, $($arg_id:$arg_ty),*) $(-> $ret_ty)? {
                    use $crate::sdk::hooks::FunctionRef;
